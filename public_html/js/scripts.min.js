...
document.addEventListener("DOMContentLoaded", function() {
  ...
  $('#project_1').click(function(){
    ...
    $('#project_1_1').addClass('active-prev')
     ...
     $('#project_1_1 .project-item-prev-text').html('Пентхаус <br>Ярцевская ул.')
    $('#project_1_2 .project-item-prev-text').html('Квартира<br>ул. Строителей')
    $('#project_1_3 .project-item-prev-text').html('Квартира ЖК  <br>«Дом на <br /> Мосфильмовской»')
     $('#project_1_4 .project-item-prev-text').html('Квартира <br>ул. Барклая')


    $('#project_1_1 .project-item-prev-text').html('Пентхаус <br>Ярцевская ул.')
    $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
    $('.project-item-text span').html('Смонтировали вентиляционную установку фирмы Komfovent, модель Domekt-R-900-V-HE C6.1с роторным рекуператором и электрическим нагревателем. Также в курительную комнату установилиавтономную систему вентиляции на базе немецкого оборудования Rukc. В спальнях и кухне-гостиной установили однопоточные кассетные кондиционеры Mitsubishi MLZ-KA25 VA и MLZ-KA35 VA с наружным блоком MXZ-6D122 VA.')
    ...
    if ($('#project_1').hasClass('active')) {
       $('#project_1_2').click(function(){
        ...
        $('.kvart_1_2').addClass('project-show')
          $('#project_1_2 .project-item-prev-text').html('Квартира<br>ул. Строителей')
    $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
    $('.project-item-text span').html('За основу вентиляции взяли установку с роторным рекуператором Amalva Komfovent REGO 900 UHE-EC-С5. Данная установка усовершенствована новой автоматикой управления C5.1, которая имеет более широкие возможности управления, а также инновационный ЖК экран и чувствительный тачпад, не уступающий современным смартфонам. Отличительной особенностью данного проекта является расположение ПВУ: установка была размещена в сплит шахте, предназначенной для монтажа кондиционеров. Согласованием размещения ПВУ занималась наша компания. Разместить ПВУ было достаточно сложной задачей, так как в сплит шахте были смонтированы наружные блоки кондиционеров, высота монтажа –15 метров, а ширина сплит шахты составляла 1500мм, ширина ПВУ– 1345мм.')
    ...
    if ($('#project_1').hasClass('active')) {
       $('#project_1_3').click(function(){
        ...
        $('#project_1_3 .project-item-prev-text').html('Квартира ЖК  <br>«Дом на <br /> Мосфильмовской»')
    $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
    $('.project-item-text span').html('Провели монтаж вентиляционной установки Komfovent, модель KOMPAKT REGO 1400 UH с роторным рекуператором, электрическим нагревателем и фреоновым охладителем. В гостиную и столовую установили канальные кондиционеры Mitsubishi. Оборудование вентиляции и кондиционирования расположили на кровле здания. Общая площадь – 420 м². ')
    ...
    if ($('#project_1').hasClass('active')) {
       ...
       $('#project_1_4 .project-item-prev-text').html('Квартира <br>ул. Барклая')
    $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
    $('.project-item-text span').html('От вводов системы вентиляции разводка по помещениям, приток и вытяжка в помещения осуществляется через решетки канального кондиционера, т.е. в обслуживаемом помещении видим только две решетки, а не четыре притоки, забор кондиционера приток и вытяжка вентиляции. Смонтировали канальные кондиционеры SEZ-KD50VAQ,SEZ-KD25VAQ с настенными пультами управления PAR-32MAAG-J и наружным блоком MXZ-5D102VA, расположенным на балконе. Всанузлах и подсобных помещениях установили принудительную вытяжку с канальными вентиляторами RUCK.')
  ...
  $('#project_2').click(function(){
    ...
    $('#project_1_1 .project-item-prev-text').html('Коттедж <br>п. Мещерский')
    $('#project_1_2 .project-item-prev-text').html('Коттедж <br>д. Городище')
    $('#project_1_3 .project-item-prev-text').html('Коттедж <br>д. Раево')
     $('#project_1_4 .project-item-prev-text').html('Коттедж <br>кп «Черничные <br /> поля»')
    ...
    $('.project-item-text span').html('Смонтировали приточно-вытяжную установку Systemair (Швеция) производительностью 2 000 куб.м/ч., с роторным рекуператором и водяным нагревателем, который подключили к газовой котельной. Установили компактные потолочные кондиционеры Mitsubishi с однонаправленной подачей воздухана первом этаже, в спальне и кухне-гостиной. В зале, а также на втором и цокольном этажах были установлены кондиционеры ведущего китайского производителя Hisense. Спроектировали, передали в производство и смонтировали бельепровод. Это инженерная система, которая перемещает бельё в прачечную коттеджа. В сущности, это тот же оцинкованный воздуховод, но гладкий внутри.')
    ...
    if ($('#project_2').hasClass('active')) {
       $('#project_1_2').click(function(){
        ...
        $('#project_1_2 .project-item-prev-text').html('Коттедж <br>д. Городище')
        $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
        $('.project-item-text span').html('Смонтирована вентиляционная установка фирмы Komfovent, модель REGO 700 VE-AC-С3 с роторным рекуператором и электрическим нагревателем. На первом и втором этаже в спальне и кухне-гостиной установили компактные канальные кондиционеры Kentatsu KMKC20HZAN1 и KMKD35HZAN1. Площадь коттеджа: 250 м². ')
    ...
    if ($('#project_2').hasClass('active')) {
       $('#project_1_3').click(function(){
        ...
        $('.project-item-text span').html('Спроектирована и смонтирована система приточно-вытяжной вентиляции с минимальным потреблением электричества. За основу взяли приточно-вытяжную установку Komfovent REGO 900 HE-AC-С3 с роторным рекуператором и электрическим нагревателем. Особенность данной установки– небольшое потребление электричества (3кВт) и возможность расположения в холодном помещении. Вентиляционную установку смонтировали в чердачном помещении, воздуховоды притока и вытяжки, обслуживающие второй этаж, утеплили для предотвращения теплопотерь и проходили в обслуживаемые помещения через перекрытия второго этажа, на первый этаж вентиляционные каналы опускались через санузел, потом прокладывались под потолком и в последующем были скрыты гипсокартонным коробом. В трех спальных комнатах заложили коммуникации под настенные кондиционеры Mitsubishi.')
    ...
    if ($('#project_2').hasClass('active')) {
       $('#project_1_4').click(function(){
        ...
        $('.project-item-text span').html('Была поставлена задача сделать КП по проекту системы вентиляции загородного дома на основе приточно-вытяжной установки с пластинчатым рекуператором японского производства Daikin, модельVAM1000FB. В процессе обнаружился существенный минус проектного решения: водяной нагреватель на заборе приточного воздуха с улицы перед рекуператором, водяной нагреватель должен был служить предварительным нагревателем в случае обморожения рекуператора, а поскольку нагреватель должен включаться при минусовых температурах следует бессмысленность водяного пред нагревателя. После предоставленных аргументов заказчику, схема была переделана и предложен электрический нагреватель, что в итоге сэкономило 60’000 рублей заказчику. ')
  ...
  $('#project_3').click(function(){
    ...
    $('#project_1_1').addClass('active-prev')
     ...
     $('#project_1_1 .project-item-prev-text').html('Дом с бассейном<br>«Сетунька»')
      $('#project_1_2 .project-item-prev-text').html('Бассейн<br>ул. Новослободская')
    $('#project_1_3 .project-item-prev-text').html('Бассейн<br>ул. Маршала <br /> Тимошенко')
    $('#project_1_4 .project-item-prev-text').html('Коттедж с бассейном<br>Сосенское <br />  поселение')
        ...
        $('.project-item-text span').html('Установлены приточно-вытяжные системы фирмы Komfovet с роторным и пластинчатым рекуператором, осушитель воздуха TURKOV OS-1200, кондиционер Mitsubishi. Площадь зеркала воды: 50 м²; Общая площадь: 214 м². ')
       ...
       $('#project_1_2').click(function(){
        ...
        $('.project-item-text span').html('Смонтировали приточно-вытяжную установку фирмы Komfovent с пластинчатым рекуператором и канальный осушитель Dantherm CDP 125 T . Площадь зеркала воды: 50 м²; Общая площадь: 300 м². ')
       ...
       $('#project_1_3').click(function(){
        ...
        $('.project-item-text span').html('Были установлены: приточно-вытяжная система фирмы Komfovent с пластинчатым рекуператором, вытяжные вентиляторы RUCK в санузлы зоны душевой. Площадь зеркала воды 36 м²; Общая площадь: 200м².  ')
    ...
    if ($('#project_3').hasClass('active')) {
       $('#project_1_4').click(function(){
        ...
        $('.project-item-text span').html('Установлены приточно-вытяжные системы фирмы Komfovet с роторным и пластинчатым рекуператором, кондиционер Hisense. Площадь: зеркала воды 20 м²; Общая площадь: 1000 м². ')
  ...
  $('#project_4').click(function(){
    ...
    $('#project_1_1').addClass('active-prev')
     ...
     $('#project_1_1 .project-item-prev-text').html('Офис<br>набережная Тараса <br /> Шевченко, 3')
      $('#project_1_2 .project-item-prev-text').html('Ресторан<br>м. Киевская')
    $('#project_1_3 .project-item-prev-text').html('Ресторан<br>м. ВДНХ')
    $('#project_1_4 .project-item-prev-text').html('Офис<br>Вятская улица, 70')



    $('#project_1_1 .project-item-prev-text').html('Офис<br>набережная Тараса <br /> Шевченко, 3')
        $('.project-item-text h1').html('Поставка и монтаж систем вентиляции и кондиционирования в офисное здание')
        $('.project-item-text span').html('Смонтирована приточно-вытяжную систему NED с водяным нагревателем. Также была установлена напольно-потолочная сплит-система AUV-48UR4SC. Офисное здание общей площадью 294 м².  ')
      ...
      $('#project_1_2 .project-item-prev-text').html('Ресторан<br>м. Киевская')
        $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
        $('.project-item-text span').html('Про проекту планировали установку настенных кондиционеров Mitsubishi, что не вписывалось в дизайн заведения. Сложность проекта заключалась в большой удаленности внутренних блоков от наружных и невозможности применения сплит систем. В кратчайшие сроки мы спроектировали систему кондиционирования на базе VRV системы производителя Hisense с кассетными внутренними блоками, что гармонично вписывалось в дизайн. Система состояла из наружного блока AVW-95UESR и внутренних блоков AVC-18UXCSEB. Система вентиляции была выбрана наборной по проекту. ')
     ...
     if ($('#project_4').hasClass('active')) {
      ...
      $('#project_1_3 .project-item-prev-text').html('Ресторан<br>м. ВДНХ')
        $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
        $('.project-item-text span').html('Поставка и монтаж систем вентиляции и кондиционирования в ресторан в Москве. Стоимость реализации проекта - 1 500 тыс. Смонтирована приточно-вытяжная система Shuft с электрическим нагревателем. Установлены настенные 3 шт. сплит-систем Hisense AS-18UR4SFAT DI6G. Общая площадь: 250 м². ')
     ...
     if ($('#project_4').hasClass('active')) {
      ...
      $('#project_1_4 .project-item-prev-text').html('Офис<br>Вятская улица, 70')
        ...
        $('.project-item-text span').html('Смонтирована приточно-вытяжная система Komfovent Domekt-R-2000-H-HW с водяным нагревателем. Общая площадь: 349 м². ')
    ...
    $('#project_5').addClass('active')
     ...
     $('.active-prev').removeClass('active-prev')
        $('#project_1_1').addClass('active-prev')
         ...
         $('#project_1_1 .project-item-prev-text').html('Объект<br>ул. Щепкина')
          $('#project_1_2 .project-item-prev-text').html('Поликлиника<br>ул. Салтыковская,11Б')
        $('#project_1_3 .project-item-prev-text').html('Anvio<br>')
         $('#project_1_4 .project-item-prev-text').html('Объект')



        $('#project_1_1 .project-item-prev-text').html('Объект<br>ул. Щепкина')
            $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
            $('.project-item-text span').html('Вентиляционный агрегат П1/В1 Vertro AV1.5 V128-1.1x30(R)-AV 1.5 V1.28-1,1 x30(R), Вентиляционный агрегат П2/В2 с резервными электродвигателями Vertro AV1.0 V1REZ.22-0.37x30(R)-AV 1.0, VIREZ/22-0,37 x30(R), Щит управления с огнезадерживающими клапанами ALFA FPS 25, 24 огнезадерживающих клапана, 1000 метров медной трубы и более 450 метров воздуховодов, 2 наружных блока VRF системы 2-WAY ECOi серии ME1, U-12ME1H8, 21 внутренних блоков, 10 сплит систем, Увлажнитель CareUE008XL001, Компрессорно-конденсаторный блок ВКК010, ВКК005. Общая площадь: 520 м². ')
         ...
         $('#project_1_2 .project-item-prev-text').html('Поликлиника<br>ул. Салтыковская,11Б')
            ...
            $('.project-item-text span').html('Смонтировано: 17 приточных установок, 40 вытяжных систем, 3300 метров воздуховодов, 82 огнезадерживающих клапана. Стоимость реализации проекта: 9 600 тыс. ')
         ...
         $('#project_1_3 .project-item-prev-text').html('Anvio<br>')
            $('.project-item-text h1').html('Проектирование, поставка и монтаж систем вентиляции и кондиционирования')
            $('.project-item-text span').html('Смонтирована вентиляционная установка фирмы Lessar LV-RACU 1200 HE-4,0-1 EC c роторным рекуператором и электрическим нагревателем. В игровой зал установлена напольно-потолочнуая сплит-система AUV-48UR4SC; в холл – настенный блок AMS-09UR4SFADB65; в малую игровую –настенный блок AMS-18UR4SFADB65. Общая площадь: 250 м²; Стоимость реализации проекта: 936 тыс. ')
         ...
         $('#project_1_4 .project-item-prev-text').html('Объект')
            ...
            $('.project-item-text span').html('Кондиционеры Fujitsu VRF системы были смонтированы с общей производительностью 300кВт. На месте блоков, установленных на кровле, планировалось сделать прогулочную зону, блоки переносились на 10 м под специально сооруженный навес. Сложность работ заключалась в уже работающей системе на озонобезопасном фреоне R410a, который очень прихотлив и не допускает наличия даже минимальной влаги в системе холодоснабжения. Работы провелись по всем нормам, что способствовало дальнейшей успешной эксплуатации системы кондиционирования в здании. Срок работ: 3 дня. ')
